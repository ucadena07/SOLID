    ...
    public partial class initial_migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "LeaveTypes",
                columns: new[] { "Id", "DateCreated", "DateModified", "Days", "DefaultDays", "Name" },
                values: new object[] { 1, new DateTime(2025, 2, 26, 6, 40, 12, 952, DateTimeKind.Local).AddTicks(5554), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 10, "Vacation" });
